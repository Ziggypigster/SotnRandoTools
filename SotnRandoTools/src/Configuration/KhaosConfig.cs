...
namespace SotnRandoTools.Configuration
{
	public class KhaosConfig
	{
		public KhaosConfig()
		{
			...
			swapInventoryRewards = new string[]
			{
			//"Shield rod",
			"Leather shield",
			"Knight shield",
		...
		public string[] swapInventoryRewards { get; set; }
		...
		public int SpawnThrowable { get; set; }
		...
		public void DefaultActions()
		{
			...
			Actions = new List<Action>
			{
				...
				new Action{Command = "rewind", Name="Rewind", AutoMayhemEnabled = false, Enabled = true, Meter = 8, AlertPath = Paths.RewindSound, Duration = new System.TimeSpan(0, 0, 1), Type = (int)Khaos.Enums.ActionType.Neutral, Cooldown = new System.TimeSpan(0, 8, 0), StartsOnCooldown = true},
				new Action{Command = "library", Name="Library", AutoMayhemEnabled = false, Enabled = true, Meter = 10, AlertPath = Paths.LibrarySound, Duration = new System.TimeSpan(0, 0, 7), Type = (int)Khaos.Enums.ActionType.Neutral, Cooldown = new System.TimeSpan(0, 10, 0), StartsOnCooldown = false},
				new Action{Command = "minstats", Name="Min Stats", AutoMayhemEnabled = false, Enabled = true, Meter = 12, AlertPath = Paths.MinStatsSound, Duration = new System.TimeSpan(0, 0, 1), Type = (int)Khaos.Enums.ActionType.Neutral, Cooldown = new System.TimeSpan(0, 10, 0), StartsOnCooldown = false},
				...
				new Action{Command = "heartsonly", Name="Hearts Only", AutoMayhemEnabled = true, Enabled = true, Meter = 6,  Duration = new System.TimeSpan(0, 1, 10), AlertPath = Paths.HeartsOnlySound, Type = (int)Khaos.Enums.ActionType.Neutral, Cooldown = new System.TimeSpan(0, 1, 15), StartsOnCooldown = false},
				new Action{Command = "challenge", Name="Challenge", AutoMayhemEnabled = true, Enabled = true, Meter = 6, Duration = new System.TimeSpan(0, 1, 0), AlertPath = Paths.ChallengeSound, Type = (int)Khaos.Enums.ActionType.Neutral, Cooldown = new System.TimeSpan(0, 3, 0), StartsOnCooldown = false},
